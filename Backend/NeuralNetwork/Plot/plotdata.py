...
# Plotting the data
plt.plot(df['added_date'], df['lbp_amount'], label='LBP Amount', marker='o', color='blue')

# Formatting the date on the x-axis
plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%Y-%m-%d'))
plt.gca().xaxis.set_major_locator(mdates.DayLocator(interval=360))  # Adjust interval to your needs
